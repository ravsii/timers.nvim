...
function M.create()
  ...
  vim.keymap.set("i", "<Down>", function() move_field(2) end, { buffer = buf, noremap = true, silent = true })
  vim.keymap.set("i", "<Up>", function() move_field(-2) end, { buffer = buf, noremap = true, silent = true })
end
